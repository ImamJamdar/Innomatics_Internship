...
A GenAI pipeline that screens resumes against a job description using LangChain (LCEL), OpenAI, and LangSmith tracing.
...
```
ai-resume-screening/
├── ai_resume_screening.ipynb   # main notebook (all code)
└── README.md
```
...
Upload `ai_resume_screening.ipynb` to [colab.research.google.com](https://colab.research.google.com) or click **File → Open notebook → Upload**.
